...
export default function MethodPageRoute() {
  return (
    <MethodPage
      ...
      indications={<><ul><li>Poprawa jakości życia w trakcie chemioterapii/radioterapii</li><li>Opieka paliatywna — redukcja zmęczenia, bólu, niepokoju</li><li>Wsparcie immunologiczne (kohortowe + RCT)</li><li>Rak trzustki — w badaniu Tröger 2014 zaobserwowano dłuższe przeżycie w grupie Iscador (wynik pojedynczego badania, wymaga potwierdzenia)</li></ul></>}
