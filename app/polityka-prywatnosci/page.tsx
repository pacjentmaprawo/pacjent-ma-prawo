    ...
    <div>
      ...
      <section className="py-16 lg:py-20 bg-background">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 prose prose-lg">
          ...
          <p className="text-navy/80 leading-relaxed mb-2">
            Opcja BCC jest <strong>domyślnie odznaczona</strong> — bez Twojego świadomego działania nie
            otrzymujemy żadnych danych.
          </p>
          <p className="text-navy/80 leading-relaxed mb-6">
            ...
            jakichkolwiek danych pozwalających zidentyfikować osobę. Aby uniknąć wielokrotnego liczenia
            tej samej osoby, w Twojej przeglądarce zapisywany jest jeden lokalny znacznik (localStorage),
            który nie jest nam przekazywany.
          </p>
