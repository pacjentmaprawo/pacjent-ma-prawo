...
import { EvidenceTypeBadge, ClinicalStatusBadge, GradeBadge } from '@/components/onkologia-integracyjna/badges'

export const metadata: Metadata = {
  title: 'Jak czytać dowody EBM w bazie onkologii integracyjnej',
