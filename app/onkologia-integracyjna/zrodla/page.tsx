...
import { METHODS } from '@/lib/onkologia-integracyjna/methods'
import { PMIDLink, CategoryBadge } from '@/components/onkologia-integracyjna/badges'
        ...
        {allSources.map((s, i) => (
          <li key={i} className="rounded-lg border bg-card p-4">
            ...
            <p className="mt-3 flex flex-wrap items-center gap-3 text-sm">
              ...
              <a
                href={`/onkologia-integracyjna/metody/${s.methodSlug}`}
