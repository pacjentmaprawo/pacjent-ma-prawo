...
export default function MethodPageRoute() {
  return (
    <MethodPage
      ...
      indications={<><ul><li>Zaburzenia snu w trakcie chemioterapii/radioterapii</li><li>Lęk i depresja związane z onkologią (ASCO/SIO Anxiety Guidelines 2023)</li><li>Redukcja zmęczenia (CRF — cancer-related fatigue)</li><li>Neuroprotekcja przy chemioterapii indukującej neuropatię (oksaliplatyna, paklitaksel)</li><li>Wsparcie tolerancji chemioterapii (Lissoni metaanaliza)</li></ul></>}
