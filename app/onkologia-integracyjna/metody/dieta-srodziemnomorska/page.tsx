...
export default function MethodPageRoute() {
  return (
    <MethodPage
      ...
      indications={<><ul><li><strong>Prewencja PIERWOTNA raka piersi</strong> — PREDIMED / Toledo 2015 (PMID 26365989) dotyczy kobiet bez raka, z wysokim ryzykiem sercowo-naczyniowym (NIE prewencji wtórnej po diagnozie). Korekta po audycie ChatGPT 28.05.2026.</li><li>Redukcja śmiertelności onkologicznej o 14% (Schwingshackl 2017 metaanaliza)</li><li>Wsparcie podczas chemioterapii (redukcja stanu zapalnego)</li><li>Zachowanie funkcji poznawczych</li><li>Synergia z aktywnością fizyczną</li></ul></>}
