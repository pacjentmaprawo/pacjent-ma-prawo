...
export const OPTIONAL_ADDRESSEES: Addressee[] = [
  ...
  },
  {
    ...
    role: 'Redakcja medialna',
    email: 'kontakt@tvn24.pl',
    category: 'media-mainstream',
    displayGroup: 'pomoc-media',
    priority: 'niski',
    defaultChecked: false,
    ...
    variantSuggestion: 'E',
    requiresVerification: true,
    note: 'Adres redakcyjny zweryfikowany na oficjalnej stronie. Możesz go zmienić na znanego Ci dziennikarza.',
  },
  {
    id: 'tvp-info',
