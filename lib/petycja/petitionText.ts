...
export const PETITION_SECTIONS: PetitionSection[] = [
  {
    ...
    paragraphs: [
      ...
      '2. Dostęp do terapii komplementarnych i alternatywnych. Państwo nie powinno blankietowo eliminować legalnych metod wspomagających, z których pacjenci dziś korzystają — w tym dostępnych legalnymi drogami: badania klinicznego oraz eksperymentu leczniczego za świadomą zgodą pacjenta (to jedyna legalna ścieżka dla substancji nieposiadających rejestracji dla ludzi). Dla pacjentów onkologicznych, dla których liczy się każdy dzień, ścieżki te powinny być szybkie i wolne od zbędnych formalności, a świadczenia finansowane przez samych pacjentów nie obciążają środków publicznych.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Kierunek pozytywny: zamiast represji państwo powinno wspierać rozwój, niezależne badania i standaryzację jakości medycyny integracyjnej — na wzór rozwiązań w innych państwach Unii Europejskiej. Podnosi to bezpieczeństwo pacjentów, rozwija polską naukę i odciąża przeciążony system publiczny, zamiast spychać świadczenia do szarej strefy.',
