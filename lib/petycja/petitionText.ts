...
export const PETITION_SECTIONS: PetitionSection[] = [
  {
    ...
    paragraphs: [
      ...
      '9. Równoległe uregulowanie ciągłości opieki w NFZ. W tym samym pakiecie legislacyjnym wnoszę o wprowadzenie regulacji eliminujących strukturalną lukę systemową w opiece publicznej (kolejki, limity, brak refundacji terapii skojarzonych w onkologii i chorobach przewlekłych), która stanowi pierwotną przyczynę zjawiska, na które ustawa ma odpowiadać.',
      '10. Klauzula bezpieczeństwa. W przypadku uchwalenia ustawy bez wprowadzenia poprawek wskazanych w pkt 1–8 wnoszę o odmowę podpisania ustawy przez Prezydenta RP w trybie art. 122 ust. 5 Konstytucji RP (weto) lub o skierowanie ustawy do Trybunału Konstytucyjnego w trybie art. 122 ust. 3 Konstytucji RP.',
    ],
  },
  {
